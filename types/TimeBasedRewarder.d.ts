...
interface TimeBasedRewarderInterface extends ethers.utils.Interface {
  functions: {
...
export class TimeBasedRewarder extends Contract {
  ...
  interface: TimeBasedRewarderInterface;
