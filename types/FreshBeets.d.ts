...
interface FreshBeetsInterface extends ethers.utils.Interface {
  functions: {
...
export class FreshBeets extends Contract {
  ...
  filters: {
    ...
    BurnFreshBeets(user: string | null, amount: null): EventFilter;

    Enter(user: string | null, amount: null): EventFilter;

    Leave(user: string | null, amount: null): EventFilter;

    MintFreshBeets(user: string | null, amount: null): EventFilter;

    ShareRevenue(amount: null): EventFilter;
