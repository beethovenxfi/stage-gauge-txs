...
interface MasterChefInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "beetx", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "beetx", data: BytesLike): Result;
...
export class MasterChef extends Contract {
  ...
  functions: {
    ...
    beetx(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    beetx(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    beetx(overrides?: CallOverrides): Promise<PopulatedTransaction>;
